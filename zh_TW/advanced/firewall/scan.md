...
掃描感知使用 eBPF 被動偵測針對您伺服器的入站連接埠掃描，記錄這些掃描，並可選擇自動封鎖發動掃描的 IP 位址。 Open **Security > Scan Awareness**.
...
All options below are configured under **Security > Settings**, in the Scan Awareness section. 點選**儲存**以套用您的變更。
